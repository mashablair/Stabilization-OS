...
- **Settings** — Configure default daily capacity for Life and Builder, export/import JSON share bundles (includes categories, tasks, app settings, time entries), CSV exports (tasks + time entries), dark mode toggle, data reset. Accessible via the gear icon in the header.
